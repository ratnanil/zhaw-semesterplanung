...
FS - Circular Economy Management (Di Nachmittag) - Patterns and Trends
(Mi Vormittag, 2. Quartal) - Remote Sensing UI (Montag Vormittag, 2
Einheiten) - ADLS Spatiotemproral DataScience (Di Vormittag)

HS - Research Methods (Mo / Di Vormittag) - ADLS Image Processing for
Remote Sensing - ADLS GIScience and Geodatabases - UI Geospatial
Computing - ADLS DataLab
